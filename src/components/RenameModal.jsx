...
const RenameModal = forwardRef(({ chatId, initialTitle, onClose, onRename }, ref) => {
  ...
  return (
    <div ref={ref} className="relative z-[9999] bg-white p-8 rounded-xl shadow-2xl max-w-sm w-full transform transition-all duration-300 ease-out scale-100 opacity-100" onClick={handleModalClick}>
